<?php
    ...
    // Calculate This Year
    {
        if ($lasted_day >= 28) {
            ...
            {
                if ($lasted_month == 1) {
                    $sql = 'SELECT month AS data_month, nocus AS mea_cust_month FROM discust WHERE district = 99 and year = '.($selectedYear-1).' and month = 12';
                } else {
                    $sql = 'SELECT month AS data_month, nocus AS mea_cust_month FROM discust WHERE district = 99 and year = '.$selectedYear.' and month < '.$lasted_month;
                }
        ...
        // Transmission Line and Station
        {
            ...
            // print_r($saifi_ls);
            // print_r($saidi_ls);
            // print_r($saifi_ls_month);
            // print_r($saidi_ls_month);
            // /calculate Transmission Line and Station saifi saidi
        ...
        // Feeder
        {
            ...
            // print_r($saifi_f);
            // print_r($saidi_f);
            // print_r($saifi_f_month);
            // print_r($saidi_f_month);
            // /calculate Feeder saifi saidi
        ...
        // EGAT
        {
            ...
            // print_r($saifi_e);
            // print_r($saidi_e);
            // print_r($saifi_e_month);
            // print_r($saidi_e_month);
            // /calculate EGAT saifi saidi
            // calculate EGAT KPI
            if ($target != 0) {
                // Target
