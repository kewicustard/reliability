...
function showGraphAndKpi(selectedYear) {
    ...
    $.get("assets/php/mea-sepa-mea-15days.php",
        ...
        function (res) {// get json data from mea-strategy-15days.php file
            ...
            // change tiTle page
            $("h1").html('MEA SEPA MEA Unofficial accumulated to <span class="text-muted" id="selectedYear_head">' + res.lasted_day + '/' + res.lasted_month + '/' + selectedYear +'</span> (เทียบเป้าหมายปี 2563)');
