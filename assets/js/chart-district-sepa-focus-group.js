...
function showGraphAndKpi_all(selectedYear, selectedDistrictValue, checkTarget) {
    ...
    if (typeof data == 'undefined' || data.data_year != selectedYear) {
        ...
        $.get("assets/php/all-district-sepa-focus-group.php",
        { 
            selectedYear: selectedYear,
            selectedDistrictValue: selectedDistrictValue,
            checkTarget: checkTarget
        },
        function (res) {// get json data from all-district-sepa-focus-group.php file
            console.log(res);
            window.data = res;
    ...
    function displayGraphandKpi_all(res) {// get json data from all-district-sepa-focus-group.php file
        console.log(res);
        // var name = [];
        
        var saifi = [], saidi = [], saifi_target = [], saidi_target = [];
        var tabb = [], tabb_code = [], last_month = res.no_month;
