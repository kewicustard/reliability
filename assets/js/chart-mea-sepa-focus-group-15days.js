...
function showGraphAndKpi(selectedYear, checkTarget) {
    ...
    $.get("assets/php/mea-sepa-focus-group-15days.php",
        { selectedYear: selectedYear, checkTarget: checkTarget },
        function (res) {// get json data from mea-sepa-focus-group-15days.php file
    ...
    function hasTarget(res) {
        ...
        // change tiTle page
        $("h1").html('MEA SEPA Focus Group 8 districts Unofficial accumulated to <span class="text-muted" id="selectedYear_head">' + res.lasted_day + '/' + res.lasted_month + '/' + selectedYear +'</span> (เทียบเป้าหมายปี ' + (parseInt(selectedYear)-1) + ')');
