$(document).ready(function () {
    ...
    showGraphAndKpi($("#selectedYear_head").text());
...
function showGraphAndKpi(selectedYear) {
    ...
    $.get("assets/php/mea-sepa-focus-group-15days.php",
        ...
        function (res) // get json data from mea-strategy.php file
        {
            ...
            // change tiTle page
            $("h1").html('MEA SEPA Focus Group 8 districts Unofficial accumulated to <span class="text-muted" id="selectedYear_head">' + res.lasted_day + '/' + res.lasted_month + '/' + selectedYear +'</span> (เทียบเป้าหมายปี 2563)');
