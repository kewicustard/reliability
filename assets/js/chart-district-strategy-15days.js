...
function showGraphAndKpi_all(selectedYear, selectedDistrictValue, checkTarget) {
    ...
    if (typeof data == 'undefined' || data.data_year != selectedYear) {
        ...
        $.get("assets/php/all-district-strategy-15days.php",
        { 
            selectedYear: selectedYear,
            selectedDistrictValue: selectedDistrictValue,
            checkTarget: checkTarget
        },
        function (res) {// get json data from all-district-strategy-15days.php file
            console.log(res);
            window.data = res;
    ...
    function displayGraphandKpi_all(res) {// get json data from all-district-strategy-15days.php file

        var saifi = [], saidi = [], saifi_target = [], saidi_target = [];
        var tabb = [], last_month = res.no_month, last_day = res.lasted_day;
        
        // $("h2").text("District Strategy 15 Days (" + last_month + "/" + selectedYear + ")");
        $("h2").text("District Unofficial (" + last_day + "/" + last_month + "/" + selectedYear + ")");
